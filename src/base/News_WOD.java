...
public class News_WOD {
    ...
    public static String yesterdayDate = DateUtils.formatDate(new Date(System.currentTimeMillis() - 24 * 60 * 60 * 1000), "yyyy-MM-dd");
    static Map<String,String> wordOfTheDayParams = EverythingParams.newBuilder().setPageSize(1).setLanguage("en").setSearchQuery("english").setFrom(yesterdayDate).setDomains("merriam-webster.com").build();
